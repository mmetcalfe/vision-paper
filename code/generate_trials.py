...
if not os.path.isdir(args.output_dir):
	print '\n## Creating output directory: {}'.format(args.output_dir)
	os.makedirs(args.output_dir)
else:
	print '\n## Using existing output directory: {}'.format(args.output_dir)

# Load template file:
stream = open(args.template_yaml, 'r')
...
for params in list(itertools.product(*indexedParams)):
    ...
    stream = file('{}/{}.yaml'.format(args.output_dir, trialName), 'w')
